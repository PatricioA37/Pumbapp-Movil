...
DocumentReference? get currentUserReference =>
    loggedIn ? ProductorRecord.collection.doc(currentUser!.uid) : null;

ProductorRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ProductorRecord.getDocument(ProductorRecord.collection.doc(uid))
              .handleError((_) {}),
    )
