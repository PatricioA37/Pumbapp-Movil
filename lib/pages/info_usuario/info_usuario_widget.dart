      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              StreamBuilder<List<ProductorRecord>>(
                stream: queryProductorRecord(
                  singleRecord: true,
                ),
                builder: (context, snapshot) {
                  ...
                  List<ProductorRecord> listViewProductorRecordList =
                      snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final listViewProductorRecord =
                      listViewProductorRecordList.isNotEmpty
                          ? listViewProductorRecordList.first
                          : null;
                  return ListView(
