...
class RegistoVacunaWidget extends StatefulWidget {
  const RegistoVacunaWidget({Key? key}) : super(key: key);

  @override
  _RegistoVacunaWidgetState createState() => _RegistoVacunaWidgetState();
}

class _RegistoVacunaWidgetState extends State<RegistoVacunaWidget> {
  late RegistoVacunaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistoVacunaModel());
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.nombreVacController,
                                            focusNode:
                                                _model.nombreVacFocusNode,
                                            autofocus: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelStyle:
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await VacunasRecord.createDoc(currentUserReference!)
                              .set({
                            ...createVacunasRecordData(
                              iDVacuna:
                                  int.tryParse(_model.iDVacController.text),
                              nombreVacuna: _model.nombreVacController.text,
                              tipoVacuna: _model.descripcionController.text,
                          ...
                          await showDialog<bool>(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Registro vacuna'),
                                content: Text(
                                    'Vacuna registrada satisfactoriamente!'),
                                actions: [
                                  TextButton(
