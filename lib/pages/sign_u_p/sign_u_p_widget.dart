                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.nombreCreateController,
                                  focusNode: _model.nombreCreateFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: _model.fonoControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await ProductorRecord.collection
                                        .doc(user.uid)
                                        .update({
                                      ...createProductorRecordData(
                                        email: _model
                                            .emailAddressCreateController.text,
                                        uid: _model.rutController.text,
                                        phoneNumber: _model.fonoController.text,
                                        displayName:
                                            _model.nombreCreateController.text,
                                        direccion:
